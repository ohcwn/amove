...
</div>`});return a},sendQuery=async b=>{const a=document.getElementById("status");var d=Date.now();a.textContent="\u041f\u043e\u0438\u0441\u043a\u2026";a.style.display="block";b=await (await fetch(`${"https://metamedia.glitch.me/api/"}${b}&with_material_data=true`)).json();const {results:c}=b;d=Date.now()-d;return c&&0!==c.length?[c,d]:(a.textContent=`\u041d\u0438\u0447\u0435\u0433\u043e \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043e (${d/1E3} \u0441\u0435\u043a.)`,b.error&&console.log(b.error),
[[],d])};
